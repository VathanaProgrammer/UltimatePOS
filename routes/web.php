...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    // web.php
    // web.php
    Route::get('/telegram', [TelegramTemplateController::class, 'telegramLinkUpdate'])->name('telegram.index');
    ...
    // Remove product
Route::delete('/products/{id}/remove', [ProductOnlineController::class, 'remove'])
->name('products.remove');

// Update status
Route::post('/products/{id}/status', [ProductOnlineController::class, 'updateStatus'])
