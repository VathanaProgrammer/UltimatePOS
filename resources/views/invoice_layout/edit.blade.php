                        ...
                        <div class="form-group">
                            ...
                            <select name="design" id="design_select" class="form-control">
                                @foreach ($designs as $key => $label)
                                    <option value="{{ $key }}" @if ($key === $invoice_layout->design) selected @endif
                        ...
                        <div class="form-group @if ($invoice_layout->design != 'columnize-taxes') hide @endif" id="columnize-taxes">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="table_tax_headings[]"
                                    placeholder="tax 2 name" value="{{ $invoice_layout->table_tax_headings[1] }}"
                                    @if ($invoice_layout->design != 'columnize-taxes') disabled @endif>
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="table_tax_headings[]"
                                    placeholder="tax 3 name" value="{{ $invoice_layout->table_tax_headings[2] }}"
                                    @if ($invoice_layout->design != 'columnize-taxes') disabled @endif>
                            </div>
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="table_tax_headings[]"
                                    placeholder="tax 4 name" value="{{ $invoice_layout->table_tax_headings[3] }}"
                                    @if ($invoice_layout->design != 'columnize-taxes') disabled @endif>
                            </div>
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('total_riel_paid_label', __('Total Riel Paid') . ':') !!}
                            {!! Form::text('total_riel_paid_label', $invoice_layout->total_riel_paid_label, [
                                'class' => 'form-control',
                                'placeholder' => __('Total Riel Paid'),
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-3">
