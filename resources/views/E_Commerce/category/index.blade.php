...
<section class="content-header py-4">
    <header class="flex justify-between">
        ...
        <button type="button" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700" data-toggle="modal" data-target="#categoryModal">
...
$(document).ready(function() {
    var table = $('#categories_table').DataTable({
        ...
        columns: [
            { data: 'name' },
            { data: 'catalog_name', defaultContent: '--' },
