    ...
    <div class="col-md-12">
        <table class="table table-condensed">
            <tr>
                ...
                <td>
                    <b class="tw-text-base md:tw-text-lg tw-font-bold">Total Riel ('៛'):</b> &nbsp;
                    <span class="price_total_riel tw-text-base md:tw-text-lg tw-font-semibold">0</span>
                </td>
                <td>
                    <b class="tw-text-base md:tw-text-lg tw-font-bold">Total USD('$'):</b> &nbsp;
            ...
            <tr>
                ...
                @if (!empty($pos_settings['amount_rounding_method']) && $pos_settings['amount_rounding_method'] > 0)
                    <td>
                        <b class="tw-text-base md:tw-text-lg tw-font-bold" id="round_off">@lang('lang_v1.round_off'):</b> <span
                            id="round_off_text">0</span>
