            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <p id="input-mobile-error" style="font-size: 15px; font-weight: bold;"
                            class="text-danger mt-1 mb-0"></p>
                    </div>
                </div>
                                <div style="margin-bottom: 12px;" class="col-md-8 col-md-offset-2 shipping_addr_div mb-10">
